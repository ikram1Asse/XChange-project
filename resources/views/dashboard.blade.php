...
<div class="container">
    ...
    <div class="row mb-4">
        <div class="col-md-3 mb-3">
                ...
                <div class="card-body text-brown">
                    <h5 class="card-title"><i class="bi bi-megaphone"></i> Mes Annonces</h5>
                    <p class="card-text display-4">{{ $stats['annonces_count'] }}</p>
                    <a href="{{ route('annonces.index') }}" class="text-white">Voir mes annonces →</a>
                </div>
            </div>
        </div>
        <div class="col-md-3 mb-3">
                ...
                <div class="card-body text-brown">
                    ...
                    <span class="text-white">Total des catégories</span>
                </div>
            </div>
        </div>
        <div class="col-md-3 mb-3">
        ...
        <div class="col-md-3 mb-3">
            <div class="card bg-primary text-white h-100">
                <div class="card-body text-brown">
                    <h5 class="card-title"><i class="bi bi-chat-dots"></i> Mes Messages</h5>
                    <p class="card-text display-4">{{ $stats['messages_count'] }}</p>
                    <a href="{{ route('messages.index') }}" class="text-white">Voir mes messages →</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-4">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0"><i class="bi bi-megaphone"></i> Mes Dernières Annonces</h5>
                    <a href="{{ route('annonces.create') }}" class="btn btn-sm btn-primary">Nouvelle annonce</a>
                </div>
                <div class="card-body">
                    <div class="list-group list-group-flush">
                        @foreach($latest_annonces as $annonce)
                            <div class="list-group-item">
                                ...
                                <small>Catégorie: {{ $annonce->categorie->libelle }}</small>
                            </div>
                        @endforeach
                    </div>
                </div>
        ...
        <div class="col-md-6 mb-4">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0"><i class="bi bi-chat-dots"></i> Mes Derniers Messages</h5>
                    <a href="{{ route('messages.create') }}" class="btn btn-sm btn-primary">Nouveau message</a>
                </div>
                <div class="card-body">
                    <div class="list-group list-group-flush">
    ...
    <div class="row">
        <div class="col-12 mb-4">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0"><i class="bi bi-tags"></i> Mes Annonces par Catégorie</h5>
                    <a href="{{ route('annonces.create') }}" class="btn btn-sm btn-primary">Nouvelle annonce</a>
                </div>
                <div class="card-body">
